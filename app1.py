...
from eval_score import RAGEvaluator

# Initialize evaluator
evaluator = RAGEvaluator()

# Page Configuration
st.set_page_config(page_title="RAG System Evaluation Dashboard", layout="wide")
...
st.markdown('<p class="title">RAG System Evaluation Dashboard</p>', unsafe_allow_html=True)
...
if st.button("Evaluate"):
    if question and context and generated_output:
        ...
        st.write("Racial Bias score indicates the presence of biased language in the generated output. Lower scores indicate less bias.")

    else:
        st.write("Please provide all inputs to evaluate.")

# Footer
st.markdown('<p class="subheader">Powered by ..................</p>', unsafe_allow_html=True)
